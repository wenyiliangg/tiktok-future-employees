...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=RetrievalMode.ANCHORED.value,
    )
    ...
    parser.add_argument("--feature-reranker", action="store_true")
    parser.add_argument("--boundary-fallback", action="store_true")
    parser.add_argument(
    ...
    config = HybridRetrievalConfig(
        ...
        rrf_k=args.rrf_k,
        enable_feature_reranker=args.feature_reranker,
        enable_boundary_fallback=args.boundary_fallback,
    )
